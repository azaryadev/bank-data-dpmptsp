...
const validationSchema: ZodType<CreateSIUPDataFormInputs> = z.object({
    ...
    tanggal_keluar: z
        .date({ message: 'Tanggal Keluar is required' })
        .nullable(),
...
const PageCreate = () => {
    ...
    console.log('dataKegiatanUsaha', optionKategoriUsaha)
    ...
    const {
        ...
        isLoading,
        error: errorCreate,
    } = useSupabaseMutation('siup_data', 'POST')
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-4  items-start">
                            ...
                            >
                                <DatePicker
                                    minDate={new Date()}
                                    value={watch('tanggal_keluar') as Date}
