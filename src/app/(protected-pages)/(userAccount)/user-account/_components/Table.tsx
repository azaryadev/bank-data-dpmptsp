'use client'
import { userAccountData } from '@/@types/userAccount'
...
const TableUserAccount: React.FC<TableUserAccountProps> = ({
    data,
    page,
    setPage,
    pageSize,
    ...
    const {
        ...
        error: errorDelete,
    } = useSupabaseMutation('user_profiles', 'DELETE')
                ...
                cell: ({ row }) => (
                    <div className="flex flex-col lg:flex-row space-y-2 lg:space-x-2 lg:space-y-0">
                        <Button
                            ...
                            onClick={() => {
                                router.push(
                                    `/user-account/update/${row.original.id}`,
                                )
                            }}
                        >
                            Update
